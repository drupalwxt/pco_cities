...
class ChallengePageModuleController extends ControllerBase {
  ...
  public function challenge_subpage($challenge, $url) {
    ...
    else if($this->validateFriendlyUrlMatch($node->get('field_challenge_subpage_title_2')->getValue()[0]['value'], $url)) {
    ...
    else if($this->validateFriendlyUrlMatch($node->get('field_challenge_subpage_title_3')->getValue()[0]['value'], $url)) {
    ...
    else if($this->validateFriendlyUrlMatch($node->get('field_challenge_subpage_title_4')->getValue()[0]['value'], $url)) {
